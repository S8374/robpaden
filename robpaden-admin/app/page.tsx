...
export default function AdminLogin() {
  ...
  return (
    <div className="flex min-h-screen bg-white text-zinc-900 font-sans selection:bg-[#7cae98]/30">
      ...
      <div className="hidden lg:flex lg:w-[70%] relative flex-col justify-between p-12 lg:p-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl">
          <h1 className="text-5xl lg:text-[4rem] font-heading font-extrabold tracking-tight leading-[1.1] mb-6 text-white">
            Supercharge your <br />
            <span className="text-[#7cae98]">sales operations.</span>
          </h1>
        ...
        <div className="relative z-10 flex items-center gap-4">
          <div className="w-10 h-10 rounded-full bg-black/60 flex items-center justify-center border border-white/10 backdrop-blur-md">
      ...
      <div className="w-full lg:w-[30%] flex flex-col justify-center items-center p-8 sm:p-12 lg:p-16 bg-white border-l border-zinc-200">
        <div className="w-full max-w-[340px] space-y-10">
          ...
          <div className="flex flex-col items-center justify-center mb-6">
             <div className="text-[#7cae98] mb-1">
                {/* Custom SVG Logo */}
             ...
             <span className="text-[#7cae98] font-heading font-bold text-lg tracking-wider">Robpaden</span>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleLogin}>
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3.5 rounded bg-zinc-50 border border-zinc-200 focus:bg-white focus:border-[#7cae98] focus:ring-1 focus:ring-[#7cae98] outline-none transition-all duration-200 text-zinc-900 placeholder-zinc-400 text-sm [&:-webkit-autofill]:[box-shadow:0_0_0_1000px_#fafafa_inset] [&:-webkit-autofill]:[-webkit-text-fill-color:black]"
                  disabled={isLoading}
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <a href="#" className="text-[11px] font-semibold text-[#7cae98] hover:text-[#5c8a75] transition-colors">
                  Forgot password?
                </a>
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-11 pr-10 py-3.5 rounded bg-zinc-50 border border-zinc-200 focus:bg-white focus:border-[#7cae98] focus:ring-1 focus:ring-[#7cae98] outline-none transition-all duration-200 text-zinc-900 placeholder-zinc-400 text-sm [&:-webkit-autofill]:[box-shadow:0_0_0_1000px_#fafafa_inset] [&:-webkit-autofill]:[-webkit-text-fill-color:black]"
                  disabled={isLoading}
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-[#7cae98] hover:bg-[#6b9d88] disabled:bg-[#7cae98]/70 text-white font-semibold py-3.5 px-4 rounded transition-all duration-200 flex items-center justify-center gap-2 mt-6 active:scale-[0.98] shadow-sm hover:shadow"
            >
              {isLoading ? (
