                ...
                <tr key={office.id} className="hover:bg-zinc-50/80 transition-colors group">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <Link 
                        href={`/dashboard/offices/${office.id}/settings`}
                        className="text-zinc-400 hover:text-zinc-900 transition-colors p-2 rounded-lg hover:bg-zinc-100 cursor-pointer" title="Office Settings"
                      >
