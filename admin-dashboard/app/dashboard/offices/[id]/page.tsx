                  ...
                  <tr key={manager.id} className="hover:bg-zinc-50/50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-right">
                      <Link 
                        ...
                        className="inline-flex items-center justify-center px-4 py-1.5 bg-blue-600 text-white text-xs font-medium rounded-lg hover:bg-blue-700 cursor-pointer transition-colors shadow-sm cursor-pointer"
                      >
                        See Details
                      </Link>
                    </td>
