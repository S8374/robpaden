  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button 
        ...
        className="p-2 bg-white cursor-pointer rounded-lg border border-zinc-200 hover:bg-zinc-50 transition-colors text-zinc-500 hover:text-zinc-900 shadow-sm relative flex items-center justify-center"
      >
