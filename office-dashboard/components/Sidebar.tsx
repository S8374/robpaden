      ...
      <div className="p-4 flex flex-col gap-1">
        ...
        >
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-full bg-zinc-200 overflow-hidden shrink-0 flex items-center justify-center text-zinc-500 text-xs font-bold shadow-sm border border-zinc-200">
              {isLoading ? null : user?.avatarUrl ? (
                <img src={user.avatarUrl} alt={user?.name || "Manager"} className="w-full h-full object-cover" />
              ) : (
        ...
        {isProfileExpanded && (
          <div className="flex flex-col gap-1 mt-1 animate-in slide-in-from-top-2 fade-in duration-200">
            <Link 
              ...
              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-zinc-500 hover:text-zinc-900 hover:bg-zinc-100 font-medium transition-colors text-left"
            >
